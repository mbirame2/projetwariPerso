...
include_once $this->targetDirs[3].'/src/DataFixtures/CompteFixtures.php';

$this->privates['doctrine.fixtures.loader'] = $instance = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);

$instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? ($this->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\CompteFixtures'] ?? ($this->privates['App\\DataFixtures\\CompteFixtures'] = new \App\DataFixtures\CompteFixtures())), 'groups' => []], 2 => ['fixture' => ($this->privates['App\\DataFixtures\\UserFixtures'] ?? $this->load('getUserFixturesService.php')), 'groups' => []]]);

...
// Returns the private 'App\Repository\EnvoiArgentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnvoiArgentRepository.php';

return $this->privates['App\\Repository\\EnvoiArgentRepository'] = new \App\Repository\EnvoiArgentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

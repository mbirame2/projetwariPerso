...
// Returns the private 'App\Repository\VersementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VersementRepository.php';

return $this->privates['App\\Repository\\VersementRepository'] = new \App\Repository\VersementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

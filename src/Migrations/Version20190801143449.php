 ...
 */
final class Version20190801143449 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE versement (id INT AUTO_INCREMENT NOT NULL, partenaire_id INT NOT NULL, montant INT NOT NULL, date_versement DATETIME NOT NULL, caissier VARCHAR(255) NOT NULL, INDEX IDX_716E936798DE13AC (partenaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
